#!C:\Users\xcb63893\AppData\Local\miniconda3\envs\MDANSE3\python.exe
...
if __name__ == "__main__":
    currentcorrelationfunction = IJob.create("CurrentCorrelationFunction")
    # Progress bars only available if tqdm available.
    # Install with `cli` optional dependency.
    currentcorrelationfunction.run(parameters, status=True, prog_bar=True)
