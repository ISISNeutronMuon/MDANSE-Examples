...
parameters = {
    ...
    "output_files": (
        "../mdanse_outputs/gaussiandynamicincoherentstructurefactor.mda",
        ["MDAFormat"],
        "INFO",
    ),  # output_files
...
if __name__ == "__main__":
    gaussiandynamicincoherentstructurefactor = IJob.create(
    ...
    gaussiandynamicincoherentstructurefactor.run(parameters, status=True, prog_bar=True)
